...
{
    public partial class FRM_Lancar_Credito_Primeiro_Uso : Form
    {
        public bool eNovo;
        public int Num_Doc;

        //Codificação para evitar de abrir o Form 2X
        private static FRM_Lancar_Credito_Primeiro_Uso _Instancia;

        public static FRM_Lancar_Credito_Primeiro_Uso GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FRM_Lancar_Credito_Primeiro_Uso();
            }
            return _Instancia;
        }

        public FRM_Lancar_Credito_Primeiro_Uso()
        {
            InitializeComponent();
            this.TXB_Num_Doc.ReadOnly = true;
        }

        private void FRM_Lancar_Credito_Primeiro_Uso_FormClosed(object sender, FormClosedEventArgs e)
        {
            _Instancia = null;
        }
        ...
        private void BTN_Salvar_Click(object sender, EventArgs e)
        {
            try
            {
                FRM_Tela_Principal frm = FRM_Tela_Principal.GetInstancia();
                string resp = "";

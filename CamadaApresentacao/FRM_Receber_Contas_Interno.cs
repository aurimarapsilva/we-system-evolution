...
{
    public partial class FRM_Receber_Contas_Interno : Form
    {
        ...
        private static FRM_Receber_Contas_Interno _Instancia;

        public static FRM_Receber_Contas_Interno GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FRM_Receber_Contas_Interno();
            }
            return _Instancia;
        }

        public FRM_Receber_Contas_Interno()
        {
            InitializeComponent();
        }
        ...
        private void FRM_Receber_Contas_Interno_FormClosed(object sender, FormClosedEventArgs e)
        {
            _Instancia = null;
            this.Limpar();
        }
        ...
        private void BTN_Receber_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    frm.Calcular_Recebimento_Interno(Convert.ToDecimal(this.TXB_Valor_Recebido.Text), this.CHK_Habilitar_Receb_Parcial.Checked, this.Valor_Conta, this.Num_Parcela, this.IdCliente, this.IdParcela);
        ...
        private void FRM_Receber_Contas_Interno_Load(object sender, EventArgs e)
        {
        ...
        private void BTN_Cancelar_Click(object sender, EventArgs e)
        {
            ...
            frm.CHK_Selecionar_Tudo.Checked = false;

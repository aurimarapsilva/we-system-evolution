...
{
    public partial class FRM_Informacoes_Cheque_Multiformas : Form
    {
        ...
        private static FRM_Informacoes_Cheque_Multiformas _Instancia;

        public static FRM_Informacoes_Cheque_Multiformas GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FRM_Informacoes_Cheque_Multiformas();
            }
            return _Instancia;
        }

        public FRM_Informacoes_Cheque_Multiformas()
        {
            InitializeComponent();
        ...
        private void FRM_Informacoes_Cheque_Multiformas_FormClosed(object sender, FormClosedEventArgs e)
        {
            _Instancia = null;
        }
        ...
        private void BTN_Confirmar_Click(object sender, EventArgs e)
        {
            ...
            {
                FRM_Detalhes_Cheque_Multiformas frm = FRM_Detalhes_Cheque_Multiformas.GetInstancia();
        ...
        private void FRM_Informacoes_Cheque_Multiformas_Load(object sender, EventArgs e)
        {

...
{
    public partial class FRM_Selecionar_Bandeira_Cartao_Debito : Form
    {
        private string bandeira = "";
      
        public FRM_Selecionar_Bandeira_Cartao_Debito()
        {
            InitializeComponent();
        }

        //Codificação para evitar de abrir o Form 2X
        private static FRM_Selecionar_Bandeira_Cartao_Debito _Instancia;

        public static FRM_Selecionar_Bandeira_Cartao_Debito GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FRM_Selecionar_Bandeira_Cartao_Debito();
            }
            return _Instancia;
        }
        ...
        private void FRM_Selecionar_Bandeira_Cartao_Debito_Load(object sender, EventArgs e)
        {
            this.Mostrar_Bandeiras();
        }

        private void FRM_Selecionar_Bandeira_Cartao_Debito_FormClosed(object sender, FormClosedEventArgs e)
        {
            _Instancia = null;

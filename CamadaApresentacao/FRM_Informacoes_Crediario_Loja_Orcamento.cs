...
{
    public partial class FRM_Informacoes_Crediario_Loja_Orcamento : Form
    {
        //Codificação para evitar de abrir o Form 2X
        private static FRM_Informacoes_Crediario_Loja_Orcamento _Instancia;

        public static FRM_Informacoes_Crediario_Loja_Orcamento GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FRM_Informacoes_Crediario_Loja_Orcamento();
            }
            return _Instancia;
        }
        ...
        public FRM_Informacoes_Crediario_Loja_Orcamento()
        {
            InitializeComponent();
        }

        private void FRM_Informacoes_Crediario_Loja_Orcamento_Load(object sender, EventArgs e)
        {
        ...
        private void BTN_Gerar_Parc_Click(object sender, EventArgs e)
        {
            if (this.Total_Geral > 0 && this.CB_Quant_Parc.Text != "")
            {
                ...
                frm.Gerar_Parcelas(this.Total_Geral, Convert.ToInt32(this.CB_Quant_Parc.Text), this.Data);
        ...
        private void FRM_Informacoes_Crediario_Loja_Orcamento_FormClosed(object sender, FormClosedEventArgs e)
        {
            _Instancia = null;
            ...
            else
            {
                ...
                FRM_Orcamento frm = FRM_Orcamento.GetInstancia();
                frm.Add_Dados_Grid_Forma_Pgto_Crediario_Loja(this.Valor_Produtos_Servicos, this.Total_Geral, Convert.ToInt32(this.CB_Quant_Parc.Text));
            }
        }
    }
}

...
{
    public partial class FRM_Informacoes_Crediario_Loja : Form
    {
        //Codificação para evitar de abrir o Form 2X
        private static FRM_Informacoes_Crediario_Loja _Instancia;

        public static FRM_Informacoes_Crediario_Loja GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FRM_Informacoes_Crediario_Loja();
            }
            return _Instancia;
        }
        ...
        public FRM_Informacoes_Crediario_Loja()
        {
            InitializeComponent();
        }

        private void FRM_Informacoes_Crediario_Loja_Load(object sender, EventArgs e)
        {
        ...
        private void FRM_Informacoes_Crediario_Loja_FormClosed(object sender, FormClosedEventArgs e)
        {
            _Instancia = null;
            ...
            else
            {
                ...
                FRM_Caixa frm = FRM_Caixa.GetInstancia();
                frm.Adicionar_Dados_Grid_Formas_Pgto_Cred_Loja(this.Valor_Produtos_Servicos, this.Total_Geral);
            }
        }
    }
}

...
{
    public partial class FRM_Entrada_em_Dinheiro_Cred_Loja : Form
    {
        //Codificação para evitar de abrir o Form 2X
        private static FRM_Entrada_em_Dinheiro_Cred_Loja _Instancia;

        public static FRM_Entrada_em_Dinheiro_Cred_Loja GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FRM_Entrada_em_Dinheiro_Cred_Loja();
            }
            return _Instancia;
        }
        ...
        public FRM_Entrada_em_Dinheiro_Cred_Loja()
        {
            InitializeComponent();
        }

        private void FRM_Detalhe_Recebimento_FormClosed(object sender, FormClosedEventArgs e)
        {
            _Instancia = null;

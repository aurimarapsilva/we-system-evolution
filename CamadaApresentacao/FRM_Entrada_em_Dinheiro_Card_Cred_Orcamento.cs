...
{
    public partial class FRM_Entrada_em_Dinheiro_Card_Cred_Orcamento : Form
    {
        //Codificação para evitar de abrir o Form 2X
        private static FRM_Entrada_em_Dinheiro_Card_Cred_Orcamento _Instancia;

        public static FRM_Entrada_em_Dinheiro_Card_Cred_Orcamento GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FRM_Entrada_em_Dinheiro_Card_Cred_Orcamento();
            }
            return _Instancia;
        }
        ...
        public FRM_Entrada_em_Dinheiro_Card_Cred_Orcamento()
        {
            InitializeComponent();
        }

        private void FRM_Entrada_em_Dinheiro_Card_Cred_Orcamento_FormClosed(object sender, FormClosedEventArgs e)
        {
            _Instancia = null;

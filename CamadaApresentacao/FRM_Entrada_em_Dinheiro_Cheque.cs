...
{
    public partial class FRM_Entrada_em_Dinheiro_Cheque : Form
    {
        //Codificação para evitar de abrir o Form 2X
        private static FRM_Entrada_em_Dinheiro_Cheque _Instancia;

        public static FRM_Entrada_em_Dinheiro_Cheque GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FRM_Entrada_em_Dinheiro_Cheque();
            }
            return _Instancia;
        }
        ...
        public FRM_Entrada_em_Dinheiro_Cheque()
        {
            InitializeComponent();
        }

        private void FRM_Entrada_em_Dinheiro_Cheque_FormClosed(object sender, FormClosedEventArgs e)
        {
            _Instancia = null;

...
{
    public partial class FRM_Selecionar_Bandeira_Cartao_Debito_Orcamento : Form
    {
        private string bandeira = "";
        
        public FRM_Selecionar_Bandeira_Cartao_Debito_Orcamento()
        {
            InitializeComponent();
        }

        //Codificação para evitar de abrir o Form 2X
        private static FRM_Selecionar_Bandeira_Cartao_Debito_Orcamento _Instancia;

        public static FRM_Selecionar_Bandeira_Cartao_Debito_Orcamento GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FRM_Selecionar_Bandeira_Cartao_Debito_Orcamento();
            }
            return _Instancia;
        }
        ...
        {
            // Obtendo daods
            this.DGV_Bandeiras.DataSource = NConfig_Cartao_Debito.Mostrar();
        ...
        private void FRM_Selecionar_Bandeira_Cartao_Debito_Orcamento_Load(object sender, EventArgs e)
        {
            this.Mostrar_Bandeiras();
        }

        private void FRM_Selecionar_Bandeira_Cartao_Debito_Orcamento_FormClosed(object sender, FormClosedEventArgs e)
        {
            _Instancia = null;

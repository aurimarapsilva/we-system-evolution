...
{
    public partial class FRM_Comp_Venda_Parcelado_Listagem : Form
    {
        private int _IdVenda;

        public FRM_Comp_Venda_Parcelado_Listagem()
        {
            InitializeComponent();
        }
        ...
        private void FRM_Comp_Venda_Parcelado_Listagem_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void FRM_Comp_Venda_Parcelado_Listagem_FormClosed(object sender, FormClosedEventArgs e)
        {

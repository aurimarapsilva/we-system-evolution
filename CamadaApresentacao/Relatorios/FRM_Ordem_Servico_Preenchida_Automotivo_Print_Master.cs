...
{
    public partial class FRM_Ordem_Servico_Preenchida_Automotivo_Print_Master : Form
    {
        private int _IdOS;
        ...
        private static FRM_Ordem_Servico_Preenchida_Automotivo_Print_Master _Instancia;

        public static FRM_Ordem_Servico_Preenchida_Automotivo_Print_Master GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FRM_Ordem_Servico_Preenchida_Automotivo_Print_Master();
            }
            return _Instancia;
        }

        public FRM_Ordem_Servico_Preenchida_Automotivo_Print_Master()
        {
            InitializeComponent();
        }
        
        private void FRM_Ordem_Servico_Preenchida_Automotivo_Print_Master_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void FRM_Ordem_Servico_Preenchida_Automotivo_Print_Master_FormClosed(object sender, FormClosedEventArgs e)
        {
            _Instancia = null;
        }
    }

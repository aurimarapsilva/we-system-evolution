...
{
    public partial class FRM_Comp_Venda_Demais_Formas_Pgto_Guiche : Form
    {
        ...
        public FRM_Comp_Venda_Demais_Formas_Pgto_Guiche()
        {
            InitializeComponent();
        }

        
        private void FRM_Comp_Venda_Demais_Formas_Pgto_Guiche_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void FRM_Comp_Venda_Demais_Formas_Pgto_Guiche_FormClosed(object sender, FormClosedEventArgs e)
        {

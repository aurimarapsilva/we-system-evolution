...
{
    public partial class FRM_Ordem_Servico_Eletro_Pagina_Anexo : Form
    {
        private int _IdOS;
        ...
        private static FRM_Ordem_Servico_Eletro_Pagina_Anexo _Instancia;

        public static FRM_Ordem_Servico_Eletro_Pagina_Anexo GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FRM_Ordem_Servico_Eletro_Pagina_Anexo();
            }
            return _Instancia;
        }

        public FRM_Ordem_Servico_Eletro_Pagina_Anexo()
        {
            InitializeComponent();
        }
        
        private void FRM_Ordem_Servico_Eletro_Pagina_Anexo_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void FRM_Ordem_Servico_Eletro_Pagina_Anexo_FormClosed(object sender, FormClosedEventArgs e)
        {
            _Instancia = null;
        }
    }

...
{
    public partial class FRM_Ver_Venda_Origem_Contas_Receber : Form
    {
        public string idvenda;
        private DataTable TBL_Info_Venda;

        //Codificação para evitar de abrir o Form 2X
        private static FRM_Ver_Venda_Origem_Contas_Receber _Instancia;

        public static FRM_Ver_Venda_Origem_Contas_Receber GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FRM_Ver_Venda_Origem_Contas_Receber();
            }
            return _Instancia;
        }

        public FRM_Ver_Venda_Origem_Contas_Receber()
        {
            InitializeComponent();
        ...
        private void FRM_Ver_Venda_Origem_Contas_Receber_Load(object sender, EventArgs e)
        {
        ...
        private void FRM_Ver_Venda_Origem_Contas_Receber_FormClosed(object sender, FormClosedEventArgs e)
        {
            _Instancia = null;
        ...
        private void FRM_Ver_Venda_Origem_Contas_Receber_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.S)
            {
                this.Limpar();

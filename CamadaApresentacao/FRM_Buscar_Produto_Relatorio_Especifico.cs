...
{
    public partial class FRM_Buscar_Produto_Relatorio_Especifico : Form
    {
        //Codificação para Evitar de abrir o mesmo form 2X.
        private static FRM_Buscar_Produto_Relatorio_Especifico _Instancia;

        public static FRM_Buscar_Produto_Relatorio_Especifico GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FRM_Buscar_Produto_Relatorio_Especifico();
            }
            return _Instancia;
        }

        public FRM_Buscar_Produto_Relatorio_Especifico()
        {
            InitializeComponent();
        }
        ...
        private void FRM_Buscar_Produto_Relatorio_Especifico_Load(object sender, EventArgs e)
        {
            this.Mostrar();
        }
        ...
        private void FRM_Buscar_Produto_Relatorio_Especifico_FormClosed(object sender, FormClosedEventArgs e)
        {
            _Instancia = null;
        }

...
{
    public partial class FRM_Atalho_Novo_Cliente_OS : Form
    {
        public bool eNovo = false;

        //Codificação para Evitar de abrir o mesmo form 2X.
        private static FRM_Atalho_Novo_Cliente_OS _Instancia;

        public static FRM_Atalho_Novo_Cliente_OS GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FRM_Atalho_Novo_Cliente_OS();
            }
            return _Instancia;
        }

        public FRM_Atalho_Novo_Cliente_OS()
        {
            InitializeComponent();
        }
        ...
        private void FRM_Atalho_Novo_Cliente_OS_Load(object sender, EventArgs e)
        {
            this.botoes();
        ...
        private void FRM_Atalho_Novo_Cliente_OS_FormClosed(object sender, FormClosedEventArgs e)
        {
            _Instancia = null;

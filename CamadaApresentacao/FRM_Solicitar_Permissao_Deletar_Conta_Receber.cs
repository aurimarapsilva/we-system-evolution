...
{
    public partial class FRM_Solicitar_Permissao_Deletar_Conta_Receber : Form
    {
        ...
        private static FRM_Solicitar_Permissao_Deletar_Conta_Receber _Instancia;

        public static FRM_Solicitar_Permissao_Deletar_Conta_Receber GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FRM_Solicitar_Permissao_Deletar_Conta_Receber();
            }
            return _Instancia;
        }
        ...
        public FRM_Solicitar_Permissao_Deletar_Conta_Receber()
        {
            InitializeComponent();
        }
        ...
        private void BTN_Confirmar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (this.TBL_Dados_Funcionarios.Rows.Count == 1)
                {
                    ...
                    frm.Deletar_Permissao_FALSE(Permissao_Concedida, this.idparcela);
        ...
        private void FRM_Solicitar_Permissao_Deletar_Conta_Receber_FormClosed(object sender, FormClosedEventArgs e)
        {
            _Instancia = null;
        }
    }

...
{
    public partial class FRM_Informacoes_Cartao_Credito_Multiformas : Form
    {
        ...
        private static FRM_Informacoes_Cartao_Credito_Multiformas _Instancia;

        public static FRM_Informacoes_Cartao_Credito_Multiformas GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FRM_Informacoes_Cartao_Credito_Multiformas();
            }
            return _Instancia;
        }
        ...
        public FRM_Informacoes_Cartao_Credito_Multiformas()
        {
            InitializeComponent();
        }
        ...
        private void BTN_Selecionar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    frm.bandeira_cartao_credito = this.TXB_Bandeira.Text;
                    frm.valor_cartao_credito = this.Valor_Parcelas;
                    frm.quant_parcelas_cartao_credito = Convert.ToInt32(this.CB_Quant_Parc.Text);
        ...
        private void FRM_Informacoes_Cartao_Credito_Multiformas_FormClosed(object sender, FormClosedEventArgs e)
        {
            _Instancia = null;
            ...
            else
            {
                ...
                caixa.Adicionar_Dados_Grid_Formas_Pgto_Card_Cred(this.Valor_Produtos_Servicos, this.Total_Geral);
        ...
        private void FRM_Informacoes_Cartao_Credito_Multiformas_Load(object sender, EventArgs e)
        {
        ...
        {
            FRM_Selecionar_Bandeira_Cartao_Credito_Multiformas frm = FRM_Selecionar_Bandeira_Cartao_Credito_Multiformas.GetInstancia();
            frm.Show();
        }

...
{
    public partial class FRM_Informacoes_Cartao_Credito : Form
    {
        ...
        public FRM_Informacoes_Cartao_Credito()
        {
            InitializeComponent();
        }
        ...
        private static FRM_Informacoes_Cartao_Credito _Instancia;

        public static FRM_Informacoes_Cartao_Credito GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FRM_Informacoes_Cartao_Credito();
            }
            return _Instancia;
        }
        ...
        private void FRM_Informacoes_Cartao_FormClosed(object sender, FormClosedEventArgs e)
        {
            _Instancia = null;
            ...
            else
            {
                ...
                FRM_Caixa frm = FRM_Caixa.GetInstancia();
                frm.Adicionar_Dados_Grid_Formas_Pgto_Card_Cred(this.Valor_Produtos_Servicos, this.Total_Geral);
            }
        }

        private void FRM_Informacoes_Cartao_Credito_Load(object sender, EventArgs e)
        {
        ...
        {
            FRM_Selecionar_Bandeira_Cartao_Credito frm = FRM_Selecionar_Bandeira_Cartao_Credito.GetInstancia();
            frm.Show();
        }

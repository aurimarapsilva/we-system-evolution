...
{
    public partial class FRM_Detalhes_Cheque : Form
    {
        ...
        public FRM_Detalhes_Cheque()
        {
            InitializeComponent();
        }

        //Codificação para evitar de abrir o Form 2X
        private static FRM_Detalhes_Cheque _Instancia;

        public static FRM_Detalhes_Cheque GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FRM_Detalhes_Cheque();
            }
            return _Instancia;
        }
        ...
        private void FRM_Detalhes_Cheque_FormClosed(object sender, FormClosedEventArgs e)
        {
            _Instancia = null;
        }

        private void FRM_Detalhes_Cheque_Load(object sender, EventArgs e)
        {

...
{
    public partial class FRM_Selecionar_Bandeira_Cartao_Credito_Orcamento : Form
    {
        private string bandeira = "";
        private decimal taxa = 0;

        public FRM_Selecionar_Bandeira_Cartao_Credito_Orcamento()
        {
            InitializeComponent();
        }

        //Codificação para evitar de abrir o Form 2X
        private static FRM_Selecionar_Bandeira_Cartao_Credito_Orcamento _Instancia;

        public static FRM_Selecionar_Bandeira_Cartao_Credito_Orcamento GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FRM_Selecionar_Bandeira_Cartao_Credito_Orcamento();
            }
            return _Instancia;
        }
        ...
        private void FRM_Selecionar_Bandeira_Cartao_Credito_Orcamento_Load(object sender, EventArgs e)
        {
            this.Mostrar_Bandeiras();
        }

        private void FRM_Selecionar_Bandeira_Cartao_Credito_Orcamento_FormClosed(object sender, FormClosedEventArgs e)
        {
            _Instancia = null;

...
{
    public partial class FRM_Entrada_em_Dinheiro_Cred_Loja_Orcamento : Form
    {
        //Codificação para evitar de abrir o Form 2X
        private static FRM_Entrada_em_Dinheiro_Cred_Loja_Orcamento _Instancia;

        public static FRM_Entrada_em_Dinheiro_Cred_Loja_Orcamento GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FRM_Entrada_em_Dinheiro_Cred_Loja_Orcamento();
            }
            return _Instancia;
        }
        ...
        public FRM_Entrada_em_Dinheiro_Cred_Loja_Orcamento()
        {
            InitializeComponent();
        }

        private void FRM_Entrada_em_Dinheiro_Cred_Loja_Orcamento_FormClosed(object sender, FormClosedEventArgs e)
        {
            _Instancia = null;
        ...
        private void BTN_Confirmar_Click(object sender, EventArgs e)
        {
            ...
            if (Opcao == DialogResult.Yes)
            {
                ...
                else
                {
                    ...
                    frm.Set_Entrada_Dinheiro(this.CB_Tipo_Recebimento.Text, Convert.ToDecimal(this.TXB_Valor_Entrada.Text));
                    frm.Adicionar_Informacoes_Crediario_Loja();
                    this.Close();
                }
            }
        }

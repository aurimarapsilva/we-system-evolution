...
{
    public partial class FRM_Informacoes_Cheque : Form
    {
        ...
        private static FRM_Informacoes_Cheque _Instancia;

        public static FRM_Informacoes_Cheque GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FRM_Informacoes_Cheque();
            }
            return _Instancia;
        }


        public FRM_Informacoes_Cheque()
        {
            InitializeComponent();
        ...
        private void FRM_Informacoes_Cheque_FormClosed(object sender, FormClosedEventArgs e)
        {
            _Instancia = null;
        }
        ...
        private void BTN_Confirmar_Click(object sender, EventArgs e)
        {
            ...
            {
                FRM_Detalhes_Cheque frm = FRM_Detalhes_Cheque.GetInstancia();
        ...
        private void FRM_Informacoes_Cheque_Load(object sender, EventArgs e)
        {
